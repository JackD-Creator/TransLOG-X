...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	if dateFrom == "" || dateTo == "" {
		jsonErr(w, "date_from and date_to required", 400); return
	}

	data, err := rpc("get_ksm_cashflow", map[string]string{
		"p_ksm_tenant_id": user.tenantID,
...
func sbURL() string {
	if v := os.Getenv("SUPABASE_URL"); v != "" { return v }
	return "https://eccermneumcskamtitqh.supabase.co"
}
